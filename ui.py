...
# --- INTERNAL TAX AUDIT GENERATION & LOGIC LAYER ---
@st.cache_data
def seed_audit_telemetry():
    """Generates corporate tax profiles locally inside the cloud container"""
...
if os.path.exists(DATA_PATH):
    ...
    with right:
        st.subheader("📍 Compliance Risk Density by Region")
